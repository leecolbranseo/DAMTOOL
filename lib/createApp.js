 ...
 * (Cloudflare Workers error 10021). Open issues on cloudflare/workers-sdk
 * confirm this is a real, currently-unfixed gap in their compat layer, not
 * a bug in this app. Since this API only ever needs to parse plain UTF-8
 * JSON bodies (no exotic charsets), a small manual parser sidesteps the
 * whole broken dependency chain and works identically in both environments.
 */
